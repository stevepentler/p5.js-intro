...
function draw(){
  ...
  rotateZ(frameCount * random(0.9));
  cone(random(200), random(300));
  torus(100, 60);
  cylinder(random(150), random(20));
  ellipsoid(random(100), random(100), random(50));
}
...
// function setup() {
//   song = loadSound('assets/Get Lucky (Vanderway Edit).mp3');
...
// ----------------------------------------
// function preload(){
//   sound = loadSound('assets/GotLucky.mp3');
// }
// function setup() {
